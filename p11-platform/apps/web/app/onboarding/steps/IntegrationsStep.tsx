...
import { IntegrationPlatform, IntegrationStatus, INTEGRATION_CONFIG } from '../types'
...
export function IntegrationsStep() {
  const { updateIntegration, formData, goToNextStep, goToPreviousStep } = useOnboarding()
